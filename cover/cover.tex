...
\begin{tikzpicture}[
  ...
  % 7) Spine: title vertically stacked, top to bottom (y descends) — 12 glyphs, 0.25 spacing
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,6.0) {國};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,5.75) {產};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,5.5) {凌};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,5.25) {凌};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,5.0) {漆};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,4.75) {劇};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,4.5) {本};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,4.25) {全};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,4.0) {文};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,3.75) {\jcz{}};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,3.5) {\jcz{}};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,3.25) {\jcz{}};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,3.0) {註};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,2.75) {音};




  % Cover art: centered on front panel
  \node[anchor=center, inner sep=0] at (9.373,5) {\includegraphics[width=4in]{../pics/from-beijing-with-love-final.jpg}};
  % \node[anchor=center, inner sep=0] at (9.373,5) {\includegraphics[width=4in]{../pics/from-beijing-with-love-text.jpg}};

  % Title line below image (front panel): 食神劇本全文 + Jyutcitzi + 註音
  \node[anchor=center, font=\Large\bfseries, black, align=center] at (9.373,1.5) {\jcz{}國產凌凌漆劇本全文註音};
